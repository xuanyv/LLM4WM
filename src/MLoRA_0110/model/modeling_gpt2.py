...
# Copied from transformers.model.llama.modeling_llama._get_unpad_data
...
class GPT2Attention(nn.Module):
    ...
    def forward(
        ...
        if encoder_hidden_states is not None:
            ...
            query = self.q_attn(hidden_states, **kwargs)
...
class GPT2FlashAttention2(GPT2Attention):
    ...
    # Copied from transformers.model.llama.modeling_llama.LlamaFlashAttention2._flash_attention_forward
    ...
    # Copied from transformers.model.llama.modeling_llama.LlamaFlashAttention2._upad_input
...
class GPT2SdpaAttention(GPT2Attention):
    ...
    def __init__(self, *args, **kwargs):
        ...
        # Idea adapted from transformers.model.bert.modeling_bert.BertSdpaSelfAttention.__init__
...
class GPT2MLP(nn.Module):
    ...
    def forward(self, hidden_states: Optional[Tuple[torch.FloatTensor]], **kwargs):
...
class GPT2DoubleHeadsModelOutput(ModelOutput):
    """
    Base class for outputs of model predicting if two sentences are consecutive or not.
...
PARALLELIZE_DOCSTRING = r"""
    ...
    Args:
        device_map (`Dict[int, list]`, optional, defaults to None):
            ...
            have fewer attention modules mapped to it than other devices. For reference, the gpt2 model have the
...
@add_start_docstrings(
    ...
    [`GPT2ForSequenceClassification`] uses the last token in order to do the classification, as other causal model
    (e.g. GPT-1) do.
